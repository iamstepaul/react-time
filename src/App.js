    ...
    return (
      <div className="App">
        <header className="App-header">
          <div className="msg">
            <div className="year">
              <span>{this.state.year}</span> / {new Date().getFullYear()}
            </div>
          </div>
          <div className="M_month">{`${this.state.M_month}`}</div>
          <div className="box">
            ...
            {this.array(7).map((x, index) => {
              return (
                <div
                  ...
                  style={{
                    transform: `rotate(${index * (360 / 7) -
                      (360 / 7) * (this.state.week - 1)}deg)`
                  }}
                >
                  {`Week ${x}`}
                </div>
